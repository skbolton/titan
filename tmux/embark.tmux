...
#Bars ---------------------------------
set -g status-left "#[fg=black,bg=green]  #S #[fg=green,bg=black]$LEFT_SEPARATOR#[bg=black,fg=brightblack]$RIGHT_SEPARATOR#[bg=brightblack,fg=brightwhite] #[fg=cyan] #[fg=white]#(task sched.before:today +PENDING count) #[fg=brightwhite]$LEFT_SUB_SEPARATOR #[fg=yellow]層#[fg=white]#(task end.after:today count) #[bg=black,fg=brightblack]$LEFT_SEPARATOR"
