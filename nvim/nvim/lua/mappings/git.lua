...
map('n', '<leader>g>', ':GitGutterNextHunk<CR>', default_opts)
map('n', '<leader>g<', ':GitGutterPrevHunk<CR>', default_opts)
...
map('n', '<leader>g-', ':GitGutterUndoHunk<CR>', default_opts)
map('n', '<leader>g+', ':GitGutterStageHunk<CR>', default_opts)
