...
let s:asphalt_subtle= { "gui": "#002c60", "cterm": "232", "cterm16": "8"}
let s:dark_asphalt = { "gui": "#00346e", "cterm": "236", "cterm16": "0"}
...
let s:p.inactive.middle = [ [ s:lfc.dark_asphalt, s:lfc.bg_dark ] ]
let s:p.inactive.right  = [ [ s:lfc.dark_asphalt, s:lfc.bg_subtle ], [ s:lfc.dark_asphalt, s:lfc.bg_subtle ] ]

let g:lightline#colorscheme#embark_solarized#palette = lightline#colorscheme#flatten(s:p)
