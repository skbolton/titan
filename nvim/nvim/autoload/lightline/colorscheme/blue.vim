...
let s:p.inactive.right = [ [ s:base2, s:base03 ] ]
let s:p.inactive.left =  [ [ s:base2, s:base03 ] ]
let s:p.inactive.middle = [ [ s:base2, s:base03 ] ]
...
let s:p.tabline.left = [ [ s:base2, s:base03 ], [ s:base2, s:base03 ] ]
...
let g:lightline#colorscheme#blue#palette = lightline#colorscheme#fill(s:p)
