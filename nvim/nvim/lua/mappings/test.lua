...
map('n', '<leader>tT', ':TestFile -strategy=vimux<CR>', default_opts)
map('n', '<leader>tn', ':TestNearest<CR>', default_opts)
map('n', '<leader>tN', ':TestNearest -strategy=vimux<CR>', default_opts)
...
map('n', '<leader>tS', ':TestSuite -strategy=vimux<CR>', default_opts)
